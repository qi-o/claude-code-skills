...
- AEs occurring in 鈮?% or 鈮?0% of patients
- Sorted by frequency
...
Assessed for eligibility (n=)
    鈫?
Randomized (n=)
    鈹溾攢 Allocated to intervention (n=)
    鈹?  鈹溾攢 Received intervention (n=)
    鈹?  鈹斺攢 Did not receive intervention (n=)
    鈹?      Give reasons
    鈹溾攢 Allocated to control (n=)
    鈹?  鈹溾攢 Received control (n=)
    鈹?  鈹斺攢 Did not receive control (n=)
    鈹?      Give reasons
    鈫?
Lost to follow-up (n=)
    Give reasons
