...
type: infographic
style: blueprint
references:                    # 鈿狅笍 ONLY if files EXIST in references/ directory
  - ref_id: 01
...
**鈿狅笍 CRITICAL - When to include `references` field**:

| Situation | Action |
|-----------|--------|
| Reference file saved to `references/` | Include in frontmatter 鉁?|
