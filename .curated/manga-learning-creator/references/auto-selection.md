...
Art Style 脳 Tone combinations work best when matched appropriately:

| Art Style | 鉁撯湏 Best | 鉁?Works | 鉁?Avoid |
|-----------|---------|---------|---------|
...
**Note**: Art Style 脳 Tone 脳 Layout can be freely combined. Incompatible combinations work but may produce unexpected results.

## Priority Order

1. User-specified options (`--art`, `--tone`, `--style`)
2. EXTEND.md defaults
3. Content signal analysis 鈫?auto-selection
