...
Ohmsha棰勮 - Educational manga with visual metaphors
...
|------|-------------------|--------|--------|
| Student (Role A) | 澶ч泟 (Nobita) | Boy, 10yo, round glasses, black hair, yellow shirt, navy shorts | Confused, asks basic but crucial questions, represents reader |
| Mentor (Role B) | 鍝嗗暒A姊?(Doraemon) | Blue robot cat, white belly, 4D pocket, red nose, golden bell | Knowledgeable, patient, uses gadgets as technical metaphors |
| Challenge (Role C) | 鑳栬檸 (Gian) | Stocky boy, small eyes, orange shirt | Represents misunderstanding, or "noise" in the data |
| Support (Role D) | 闈欓 (Shizuka) | Cute girl, black short hair, pink dress | Asks clarifying questions, provides alternative perspectives |
...
To use custom characters: `--characters "Student:灏忔槑,Mentor:鏁欐巿"` or define in EXTEND.md.
...
1. Student expresses confusion with visual indicator (锛? spiral eyes)
...
- 鉁?Every concept is a visual metaphor
- 鉁?Characters are DOING things, not just talking
- 鉁?Clear student/mentor dynamic
- 鉁?Gadgets and props drive the explanation
- 鉁?Expressive manga-style emotions
- 鉁?Information density through visual design, not text walls
- 鉁?Narrative page titles
