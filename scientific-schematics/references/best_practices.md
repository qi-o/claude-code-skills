...
Example:
Image size: 2400 脳 1800 pixels
Final print size: 8 脳 6 inches
DPI = 2400 / 8 = 300 鉁?(acceptable)
```
...
- Include units in parentheses: "Temperature (掳C)"
...
```
figures/
鈹溾攢鈹€ source/          # Editable source files
鈹?  鈹溾攢鈹€ diagram1.tex
鈹?  鈹溾攢鈹€ circuit.py
鈹?  鈹斺攢鈹€ pathway.svg
鈹溾攢鈹€ generated/       # Auto-generated outputs
鈹?  鈹溾攢鈹€ diagram1.pdf
鈹?  鈹溾攢鈹€ circuit.pdf
鈹?  鈹斺攢鈹€ pathway.pdf
鈹斺攢鈹€ final/          # Final submission versions
    鈹溾攢鈹€ figure1.pdf
    鈹斺攢鈹€ figure2.pdf
```
