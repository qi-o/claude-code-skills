...
1. **ACE Inhibitor or ARB or ARNI**
   ...
   - ARNI (Sacubitril/Valsartan): 24/26mg BID 鈫?97/103mg BID (superior to ACE/ARB)
   - Monitor: BP, renal function, potassium

2. **Beta-Blocker**
   - Carvedilol 3.125-6.25mg BID 鈫?25mg BID (target)
   - Metoprolol succinate 12.5-25mg daily 鈫?200mg daily
   - Bisoprolol 1.25mg 鈫?10mg daily
   - Titrate slowly, monitor HR, BP

3. **Mineralocorticoid Receptor Antagonist (MRA)**
   - Spironolactone 12.5-25mg daily (up to 50mg)
   - Eplerenone 25mg daily 鈫?50mg daily
...
- Bedroom: Dark, quiet, cool (60-67掳F)
...
**Procedure**: Trial lead placement (5-7 days), if successful 鈫?permanent implant
...
2. **Severity-Appropriate**: Mild 鈫?conservative; severe 鈫?aggressive
