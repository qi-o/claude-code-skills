...
**鈿狅笍 MANDATORY: Every treatment plan MUST include at least 1 AI-generated figure using the scientific-schematics skill.**
...
PRIMARY TREATMENT REGIMEN
  鈥?Medication 1: dose, frequency, duration
  鈥?Procedure: specific details
  鈥?Monitoring: what and when

SUPPORTIVE CARE
  鈥?Key supportive medications
...
鉁?**Shared Decision-Making**: Involve patients in goal-setting and treatment choices  
鉁?**Cultural Competence**: Respect cultural beliefs, language preferences, health literacy  
鉁?**Patient Preferences**: Honor treatment preferences and personal values  
鉁?**Individualization**: Tailor plans to patient's unique circumstances  
鉁?**Empowerment**: Support patient activation and self-management  

### Evidence-Based Practice

鉁?**Clinical Guidelines**: Follow current specialty society recommendations  
鉁?**Quality Measures**: Incorporate HEDIS, CMS quality measures  
鉁?**Comparative Effectiveness**: Use treatments with proven efficacy  
鉁?**Avoid Low-Value Care**: Eliminate unnecessary tests and interventions  
鉁?**Stay Current**: Update plans based on emerging evidence  

### Documentation Standards

鉁?**Completeness**: Include all required elements  
鉁?**Clarity**: Use clear, professional medical language  
鉁?**Accuracy**: Ensure factual correctness and current information  
鉁?**Timeliness**: Document plans promptly  
鉁?**Legibility**: Professional formatting and organization  
鉁?**Signature and Date**: Authenticate all treatment plans  

### Regulatory Compliance

鉁?**HIPAA Privacy**: De-identify all protected health information  
鉁?**Informed Consent**: Document patient understanding and agreement  
鉁?**Billing Support**: Include documentation to support medical necessity  
鉁?**Quality Reporting**: Enable extraction of quality metrics  
鉁?**Legal Protection**: Maintain defensible clinical documentation  

### Multidisciplinary Coordination

鉁?**Team Communication**: Share plans across care team  
鉁?**Role Clarity**: Define responsibilities for each team member  
鉁?**Care Transitions**: Ensure continuity across settings  
鉁?**Specialist Integration**: Coordinate with subspecialty care  
鉁?**Patient-Centered Medical Home**: Align with PCMH principles  
...
**Issue: Missing characters (鉁? 鈮? etc.)**
...
1. **Appropriate Box Usage**
   - Match box type to content purpose (goals鈫抔reen, warnings鈫抷ellow/red)
