...
description: 璁烘枃璐ㄩ噺鑷宸ュ叿銆俆his skill should be used when the user asks to "review paper quality", "check paper completeness", "validate paper structure", "self-review before submission", "璁烘枃鑷", "璁烘枃妫€鏌?, "璁烘枃璐ㄩ噺妫€鏌?, or "paper quality check". Provides comprehensive quality assurance checklist for academic papers.
allowed-tools: Read, Edit, Grep
version: 0.1.0
license: MIT
github_url: https://github.com/Galaxy-Dawn/claude-scholar
github_hash: 1bfff897019bfed0fc4b0cc813fe04d22222add5
metadata:
  category: research
  source: claude-scholar
---
