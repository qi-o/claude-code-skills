...
- `counts`: pandas DataFrame of shape (samples 脳 genes) containing non-negative integer read counts
- `metadata`: pandas DataFrame of shape (samples 脳 variables) with sample annotations
