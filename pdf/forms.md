...
*Checkboxes*
```
Are you a US citizen? Yes 鈻? No 鈻?
```
For checkboxes:
- Look for small square boxes (鈻? - these are the actual checkboxes to target. They may be to the left or right of their labels.
