...
> **For complete XML schema and editing patterns, see [references/docx_reference.md](references/docx_reference.md)**

**Key patterns:**
- Tracked changes: `<w:ins>` and `<w:del>` with author/date attributes
- Comments: `<w:commentRangeStart>` and `<w:commentRangeEnd>` as siblings of `<w:r>`
- Images: Add to `word/media/`, update relationships and content types
- Schema compliance: Proper element order in `<w:pPr>`, `xml:space="preserve"` for whitespace
