...
```
pub/clinvar/
鈹溾攢鈹€ xml/                          # XML data files
鈹?  鈹溾攢鈹€ clinvar_variation/       # VCV files (variant-centric)
鈹?  鈹?  鈹溾攢鈹€ weekly_release/      # Weekly updates
鈹?  鈹?  鈹斺攢鈹€ archive/             # Monthly archives
鈹?  鈹斺攢鈹€ RCV/                     # RCV files (variant-condition pairs)
鈹?      鈹溾攢鈹€ weekly_release/
鈹?      鈹斺攢鈹€ archive/
鈹溾攢鈹€ vcf_GRCh37/                  # VCF files (GRCh37/hg19)
鈹溾攢鈹€ vcf_GRCh38/                  # VCF files (GRCh38/hg38)
鈹溾攢鈹€ tab_delimited/               # Tab-delimited summary files
鈹?  鈹溾攢鈹€ variant_summary.txt.gz
鈹?  鈹溾攢鈹€ var_citations.txt.gz
鈹?  鈹斺攢鈹€ cross_references.txt.gz
鈹斺攢鈹€ README.txt                   # Format documentation
```
...
- Check review status (prefer 鈽呪槄鈽?or 鈽呪槄鈽呪槄 ratings)
