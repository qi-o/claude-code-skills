...
|-------|---------------|-------------|--------|
| 鈽呪槄鈽呪槄 | **Practice Guideline** | Reviewed by expert panel with published guidelines | Highest |
| 鈽呪槄鈽?| **Expert Panel Review** | Reviewed by expert panel (e.g., ClinGen) | High |
| 鈽呪槄 | **Multiple Submitters, No Conflicts** | 鈮? submitters with same classification | Moderate |
| 鈽?| **Criteria Provided, Single Submitter** | One submitter with supporting evidence | Standard |
| 鈽?| **No Assertion Criteria** | Classification without documented criteria | Lowest |
| 鈽?| **No Assertion Provided** | No classification submitted | None |
...
1. **Always check review status** - Prefer variants with 鈽呪槄鈽?or 鈽呪槄鈽呪槄 ratings
